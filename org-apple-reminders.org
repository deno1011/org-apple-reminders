...
Child TODO headings under those sections may be created as Apple reminders.
...
explicit REMINDER_LIST property.  New-item creation is synchronous so the
returned id can be stamped back.
